...
export default class PathfindingVisualizer extends Component {
  ...
  visualizeDijkstra() {
    this.setState({ topMessage: "Creator : Nikhil Rai" });
  ...
  render() {
    ...
    } else if (topMessage === "Creator : Nikhil Rai") {
    ...
    if (topMessage === "Creator : Nikhil Rai") {
      textBox = null;
      ...
      <div className="pathfindingVisualizer">
        <div className="container">
          <div className="heading">
            <h2 onClick={showPopUp}>Path Visualizer</h2>
            <h2>Made by Nikhil Rai</h2>
            <h2>{topMessage}</h2>
          </div>
